...
// https://api.themoviedb.org/3/movie/550?api_key=69fe6053ab2b06475da63a7f3438599f
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const res = await axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=69fe6053ab2b06475da63a7f3438599f&query='${debounceValue}'`
      );
  ...
  return (
    <div className="bg-white p-3 rounded-2xl shadow-sm flex flex-col">
      ...
      <div className="p-7 flex flex-1 flex-col">
        ...
        <p className="text-sm font-normal text-[#999999] mb-6 !leading-loose">
        ...
        <img
          src={
            data.poster_path
              ...
              : "https://images.unsplash.com/photo-1665153856965-79caf2747887?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxNXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60"
          }
          alt=""
